 ...
 */
transaction(creatorId: String, assetId: String, content: String, address: Address, royalty: UFix64, series: UInt32, type: UInt16, maxSupply: UInt16) {
    ...
    execute {
        let asset = MintasticNFT.Asset(creatorId: creatorId, assetId: assetId, content: content, address: address, royalty: royalty, series: series, type: type)
